...
<div class="bg-image bg-img1">
	<div class="container ">
		...
		<sf:form
			action="${pageContext.request.contextPath}/admin/adminViewBoard/adminWriteBoard/${page}?${_csrf.parameterName}=${_csrf.token}"
			...
			<a href="<c:url value="/admin/adminViewBoard?page=${page}"/>" class="btn btn-outline-primary">Cancel</a>
